    ...
    return (
        <div className="m-4 gap-4 md:w-[70%]">
            ...
            <ul className="list-disc ml-8">
                ...
                <li><a href="https://en.wikipedia.org/wiki/Binary_number#Arithmetic">:Binary Arithmetic</a> - <a className="text-indigo-800 underline" href="/tools/binary-arithmetic">Link</a></li>
            </ul>
        </div>
    )
}
